        ...
        <div class="col-lg-10 col-xl-10">
          <div class="card" style="border-radius: 10px;">
            ...
            <div class="card-footer border-0 px-4 py-5"
              style="background-image: linear-gradient(310deg, #288f25, #4eac4c); border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
              <h5 class="d-flex align-items-center justify-content-end text-white text-uppercase mb-0">Grand Total: <span class="h2 mb-0 ms-2 text-white">£{{ number_format($grandTotal + ($grandTotal * 0.1) / 100 + 5, 2) }}</span></h5>
            </div>
          </div>
        </div>
      </div>
