...
@section('content')
  ...
  <form method="POST" action="{{ url('foods') }}" enctype="multipart/form-data">
    @csrf
    <div class="row">
      <div class="col-12">
          ...
          <div class="card-body pt-0">
            <div class="row">
              ...
              <div class="col-sm-6 col-12">
                ...
                <div class="input-group">
                  ...
                  <input id="price" name="price" class="form-control" type="text" placeholder="14.99"
                    onfocus="focused(this)" onfocusout="defocused(this)" value="{{ old('price') }}">
              ...
              <div class="col-sm-4 col-12">
                ...
                <div class="input-group">
                  <input id="rating" name="rating" class="form-control" type="text" placeholder="4.9"
                    onfocus="focused(this)" onfocusout="defocused(this)" value="{{ old('rating') }}">
                </div>
                @error('rating')
                  <div class="text-danger text-sm">{{ $message }}</div>
                @enderror
              ...
              <div class="col-sm-4 col-12">
                ...
                <div class="input-group">
                  <input id="photo" name="photo" class="form-control" type="file" placeholder="Pizza"
              ...
              <div class="col-sm-6 col-12">
                ...
                <div class="input-group">
                  <textarea name="ingredients" id="ingredients" cols="30" rows="5" class="form-control"
                    placeholder="Balsamic Vinaigrette, Pesto, Tomato, Swiss Cheese">{{ old('ingredients') }}</textarea>
              ...
              <div class="col-sm-6 col-12">
                ...
                <div class="input-group">
                  <textarea name="description" id="description" cols="30" rows="5" class="form-control"
                    placeholder="The literal translation of Nasi Goreng is “fried rice” in Indonesian and Malaysian – and that’s exactly what it is! It’s mainly rice with just a little bit of meat and just onion for the vegetables.">{{ old('description') }}</textarea>
                </div>
                @error('description')
                  <div class="text-danger text-sm">{{ $message }}</div>
                @enderror
